...
class WebviewSprInicio extends StatefulWidget {
  final String url;
  final bool appbar, calculadora, firstTime;

  WebviewSprInicio(this.url, this.appbar,
      {this.calculadora = false, this.firstTime = true});

  @override
  _WebviewSprInicioState createState() => _WebviewSprInicioState();
}

class _WebviewSprInicioState extends State<WebviewSprInicio> {
